...
abstract class TestCase extends OrchestraTestCase
{
    ...
    private function postRoutes($router)
    {
        ...
        $router->post('posts/restore-all-trashed', [PostController::class, 'restoreAllTrashed'])->name('posts.restore-all-trashed');
        $router->post('posts/force-delete-trashed', [PostController::class, 'forceDeleteTrashed'])->name('posts.force-delete-trashed');
        ...
        $router->put('posts/{id}/status-change/{column}', [PostController::class, 'changeStatusOtherColumn'])->name('posts.changeStatusOtherColumn');
        $router->put('posts/{id}/status-change', [PostController::class, 'changeStatus'])->name('posts.changeStatus');
        $router->put('posts/{id}/restore-trash', [PostController::class, 'restoreTrashed'])->name('posts.restoreTrashed');
    ...
    private function tagRoutes($router)
    {
        ...
        $router->post('tags/restore-all-trashed', [TagController::class, 'restoreAllTrashed'])->name('tags.restore-all-trashed');
        $router->post('tags/force-delete-trashed', [TagController::class, 'forceDeleteTrashed'])->name('tags.force-delete-trashed');
        $router->get('tags/{id}', [TagController::class, 'show'])->name('tags.show');
        $router->put('tags/{id}', [TagController::class, 'update'])->name('tags.update');
        $router->put('tags/{id}/status-change/{column}', [TagController::class, 'changeStatusOtherColumn'])->name('tags.changeStatusOtherColumn');
        $router->put('tags/{id}/status-change', [TagController::class, 'changeStatus'])->name('tags.changeStatus');
        $router->put('tags/{id}/restore-trash', [TagController::class, 'restoreTrashed'])->name('tags.restoreTrashed');
    ...
    private function userRoutes($router)
    {
        ...
        $router->post('users/restore-all-trashed', [UserController::class, 'restoreAllTrashed'])->name('users.restore-all-trashed');
        $router->post('users/force-delete-trashed', [UserController::class, 'forceDeleteTrashed'])->name('users.force-delete-trashed');
        ...
        $router->put('users/{id}/status-change/{column}', [UserController::class, 'changeStatusOtherColumn'])->name('users.changeStatusOtherColumn');
        $router->put('users/{id}/status-change', [UserController::class, 'changeStatus'])->name('users.changeStatus');
        $router->put('users/{id}/restore-trash', [UserController::class, 'restoreTrashed'])->name('users.restoreTrashed');
